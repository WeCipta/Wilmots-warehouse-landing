      ...
      >
        <div className="flex h-full flex-col gap-10 overflow-hidden border border-white/20 bg-background px-5 pt-6 lg:grid lg:min-h-0 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.45fr)] lg:gap-(--grid-cell) lg:overflow-visible lg:p-8">
          <a
            ...
            onClick={() => onNavigate()}
            className="group relative order-last mt-auto block w-full shrink-0 lg:order-0 lg:mt-0 lg:h-full lg:min-h-0 lg:shrink lg:overflow-hidden lg:border-2 lg:border-white lg:shadow-[4px_4px_0_0_rgba(255,255,255,0.35)]"
          >
            <ProductImage
            ...
            />
            <ExternalLinkIcon className="pointer-events-none absolute right-3 top-3 size-7 text-white mix-blend-difference lg:top-auto lg:right-4 lg:bottom-4 lg:size-10" />
          </a>
